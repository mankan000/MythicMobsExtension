...
public class MStatueMechanic extends SkillMechanic
    ...
    public MStatueMechanic(String skill, MythicLineConfig mlc) {
        ...
        this.material=Main.mythicmobs.getMobManager().getMythicMob(i);
        if (this.material==null&&Main.mythicmobs.getMobManager().getMobTypes().size()>0) {
            this.material=Main.mythicmobs.getMobManager().getMobTypes().iterator().next();
        }
